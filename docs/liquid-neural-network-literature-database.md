...
| 应用论文 - 医疗健康 | 8+篇 | ECG/EEG分析、诊断 |
| 混合架构 | 10+篇 | LNN+Transformer、LNN+LSTM |
| 边缘设备/效率 | 10+篇 | 低功耗、边缘AI部署 |
| 基础模型 | 8+篇 | Liquid Foundation Models |
| 神经电路策略 | 8+篇 | NCP、生物启发架构 |
| 对比研究 | 3+篇 | vs RNN/LSTM/Transformer |
| 开源实现/教程 | 15+篇 | GitHub项目、教程 |
| **总计** | **90+篇** | 全面覆盖理论、应用、代码 |
